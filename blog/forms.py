...
class ContactForm(forms.Form):
    ...
    liste_nageurs = forms.CharField(help_text="Entrez une liste de nageurs sous la forme : 'NOM1 Prénom1/NOM2 Prénom2/NOM3 Prénom3/../' Avec un espace entre le NOM et le Prénom, mais sans espaces entre les // et les noms. le NOM doit être tout en majuscules et le Prénom avec seulement la première lettre en majuscule et en conservant les accents si il y en a.",widget=forms.Textarea,required=False)
